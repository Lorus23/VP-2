...
<?php endif; ?>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="inputDescription" rows="2" placeholder="Напишите пару слов о себе"
        ...
        <div class="form-group form-group-left-align">
            <div class="form-subgroup3-left">
                ...
                <input type="text" class="form-control" id="inputLogin" placeholder="Придумайте логин" name="login"
                       required>
            </div>
            <div class="form-subgroup3-left">
